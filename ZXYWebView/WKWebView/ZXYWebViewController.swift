...
public class ZXYWebViewController: UIViewController {
    ...
    var bl_naviBarHidden: Bool = false
    ...
    fileprivate var kScreenHeight: CGFloat = 667
    fileprivate var kSafeAreaTopInset: CGFloat = 20
    fileprivate var kNavigationBarHeight: CGFloat = 64
    fileprivate var kSafeAreaBottomInset: CGFloat = 49
...
//        self.view.bringSubviewToFront(navBar)
        ...
        btn.frame = CGRect(x: 0, y: 60, width: 60, height: 64)
...
extension ZXYWebViewController {
    ...
    func showFrameworkLoading(offsetY:CGFloat){
